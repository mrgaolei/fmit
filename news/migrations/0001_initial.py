# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-23 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.SmallIntegerField(choices=[(0, 'VOL'), (1, 'Spec'), (2, 'Weekly'), (3, 'Discuss')], db_index=True, default=0, verbose_name='\u7c7b\u578b')),
                ('album', models.ImageField(upload_to=b'album', verbose_name='\u5c01\u9762')),
        ...
        migrations.AddField(
            model_name='macskill',
            name='volume',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='mac_skill', to='news.Volume'),
        ),
        migrations.AddField(
