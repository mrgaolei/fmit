...
class Profile(models.Model):
	...
	third = models.SmallIntegerField(u"认证类型", choices=THIRDAUTH_CHOICES, default=WEIBO)
...
class ThirdAuth(models.Model):
	profile = models.ForeignKey(Profile, verbose_name=u"用户档案")
	...
	class Meta:
		verbose_name = u"第三方认证"
		verbose_name_plural = verbose_name
		unique_together = (("profile", "auth_type"),)
